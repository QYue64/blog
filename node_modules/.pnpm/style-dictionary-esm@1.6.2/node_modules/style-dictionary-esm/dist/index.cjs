...
function resolveTemplate(_path) {
  const _dir = path4.resolve(path4.dirname(fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('out.js', document.baseURI).href)))), "../templates");
...
function resolveFileContent_default(resolvedPath) {
  ...
  if (resolvedPath.match(/.json5$/)) {
    ...
    _content = jiti__default.default((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (document.currentScript && document.currentScript.src || new URL('out.js', document.baseURI).href)), { interopDefault: true, cache: false, v8cache: false, requireCache: false })(resolvedPath);
  }
  return _content;
}
...
function combineJSON(arr, deep, collision, source, parsers = []) {
  ...
  for (i = 0; i < arr.length; i++) {
    const new_files = glob__default.default.sync(arr[i], {}).reverse();
