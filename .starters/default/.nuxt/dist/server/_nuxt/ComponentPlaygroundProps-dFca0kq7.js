import __nuxt_component_0 from "./ProseH4-ka9vr7Dq.js";
import __nuxt_component_1$1 from "./ProseCodeInline-pV8y8HjW.js";
import __nuxt_component_2 from "./Badge-sDS-OQuI.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "component-playground-data-section" }, _attrs))} data-v-e4625f9c><!--[-->`);
      ssrRenderList(unref(componentProps), (prop) => {
        _push(`<div data-v-e4625f9c><div${ssrRenderAttr("id", prop.name)} class="prop-title" data-v-e4625f9c>`);
        ...
        _push(`<input${ssrRenderAttr("value", unref(formData)[prop.name])} data-v-e4625f9c></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt-themes+elements@0.9.5_rollup@3.29.3_vue@3.4.15/node_modules/@nuxt-themes/elements/components/meta/ComponentPlaygroundProps.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e4625f9c"]]);
export {
  __nuxt_component_1 as default
};
//# sourceMappingURL=ComponentPlaygroundProps-dFca0kq7.js.map
