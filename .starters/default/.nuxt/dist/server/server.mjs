import { hasInjectionContext, getCurrentInstance, effectScope, reactive, version, unref, inject, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, ref, watch, onScopeDispose, watchEffect, defineComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, useSSRContext, resolveComponent, createTextVNode, toDisplayString, withAsyncContext, openBlock, createBlock, createCommentVNode, createElementBlock, Fragment, provide, Suspense, Transition, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import { ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/document-driven-jeT_SgAC.js").then((m) => m.default || m)
  }
];
...
const LazyArticlesList = defineAsyncComponent(() => import("./_nuxt/ArticlesList-9Jp_zQwG.js").then((r) => r.default));
const LazyArticlesListItem = defineAsyncComponent(() => import("./_nuxt/ArticlesListItem-NYaSM8ty.js").then((r) => r.default));
const LazyContactForm = defineAsyncComponent(() => import("./_nuxt/ContactForm-_1eKUwN3.js").then((r) => r.default));
const LazyGallery = defineAsyncComponent(() => import("./_nuxt/Gallery-epKFEjJN.js").then((r) => r.default));
const LazyHero = defineAsyncComponent(() => import("./_nuxt/Hero-ufBww48Z.js").then((r) => r.default));
const LazyInput = defineAsyncComponent(() => import("./_nuxt/Input-TKvy5OZt.js").then((r) => r.default));
...
const LazyButton = defineAsyncComponent(() => import("./_nuxt/Button-NVNm0C26.js").then((r) => r.default));
const LazyColorModeSwitch = defineAsyncComponent(() => Promise.resolve().then(function() {
  return ColorModeSwitch;
}).then((r) => r.default));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenNotFound-kZ7PaaPT.js").then((r) => r.default));
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-JekqIH0i.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-RqoBfPFF.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-nY8yK-W7.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-pV8y8HjW.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-H4Y-rPaK.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-UhvqTn2y.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-RNWOCsWl.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-VFk5vZ12.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-ka9vr7Dq.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5--Sdy2z5W.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-Q0OgRxrf.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-ZKGHbtQy.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-N5fFwu6u.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-gTqpQOci.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-KNhBPwIk.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-vkVV1HYm.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-F6Q1wyaQ.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-gLGchm5k.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-UsS2D7qV.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-5WlfbjbN.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-_oqeiml4.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-X47V0bCZ.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-5ymOqWBC.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-Xy8DV4Ep.js").then((r) => r.default));
const LazyAlert = defineAsyncComponent(() => import("./_nuxt/Alert-n2laLqAb.js").then((r) => r.default));
const LazyBadge = defineAsyncComponent(() => import("./_nuxt/Badge-sDS-OQuI.js").then((r) => r.default));
const LazyButtonLink = defineAsyncComponent(() => import("./_nuxt/ButtonLink-qQDc-wYi.js").then((r) => r.default));
const LazyCallout = defineAsyncComponent(() => import("./_nuxt/Callout-yhgSm1y9.js").then((r) => r.default));
const LazyCodeBlock = defineAsyncComponent(() => import("./_nuxt/CodeBlock-ttdlwvjB.js").then((r) => r.default));
const LazyCodeGroup = defineAsyncComponent(() => import("./_nuxt/CodeGroup-_Xjf7xSq.js").then((r) => r.default));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r.default));
const LazyCopyButton = defineAsyncComponent(() => import("./_nuxt/CopyButton-3BO2Og9K.js").then((r) => r.default));
const LazyEllipsis = defineAsyncComponent(() => import("./_nuxt/Ellipsis-k84f258M.js").then((r) => r.default));
const LazyList = defineAsyncComponent(() => import("./_nuxt/List-Ep2NZcBn.js").then((r) => r.default));
const LazyNuxtImg = defineAsyncComponent(() => import("./_nuxt/NuxtImg-_wBVCxI2.js").then((r) => r.default));
const LazyProps = defineAsyncComponent(() => import("./_nuxt/Props-VyGZ5OxL.js").then((r) => r.default));
const LazySandbox = defineAsyncComponent(() => import("./_nuxt/Sandbox--Tz4lrN8.js").then((r) => r.default));
const LazySourceLink = defineAsyncComponent(() => import("./_nuxt/SourceLink-b8TQawAC.js").then((r) => r.default));
const LazyTabsHeader = defineAsyncComponent(() => import("./_nuxt/TabsHeader-0wRfio_G.js").then((r) => r.default));
const LazyTerminal = defineAsyncComponent(() => import("./_nuxt/Terminal-Lp8B9VIU.js").then((r) => r.default));
const LazyVideoPlayer = defineAsyncComponent(() => import("./_nuxt/VideoPlayer-yq52JgUi.js").then((r) => r.default));
const LazyIconCodeSandBox = defineAsyncComponent(() => import("./_nuxt/IconCodeSandBox-P1TvIRFz.js").then((r) => r.default));
const LazyIconDocus = defineAsyncComponent(() => import("./_nuxt/IconDocus-In7sWJrr.js").then((r) => r.default));
const LazyIconNuxt = defineAsyncComponent(() => import("./_nuxt/IconNuxt-woQmg3Ft.js").then((r) => r.default));
const LazyIconNuxtContent = defineAsyncComponent(() => import("./_nuxt/IconNuxtContent-NjaqANYb.js").then((r) => r.default));
const LazyIconNuxtLabs = defineAsyncComponent(() => import("./_nuxt/IconNuxtLabs-OvTaDgLA.js").then((r) => r.default));
const LazyIconNuxtStudio = defineAsyncComponent(() => import("./_nuxt/IconNuxtStudio-g_DNtnH2.js").then((r) => r.default));
const LazyIconStackBlitz = defineAsyncComponent(() => import("./_nuxt/IconStackBlitz-RoqcuoV0.js").then((r) => r.default));
const LazyIconVueTelescope = defineAsyncComponent(() => import("./_nuxt/IconVueTelescope-W78dwzdi.js").then((r) => r.default));
const LazyBlockHero = defineAsyncComponent(() => import("./_nuxt/BlockHero-eIu4QwsI.js").then((r) => r.default));
const LazyCard = defineAsyncComponent(() => import("./_nuxt/Card-UoyMds3m.js").then((r) => r.default));
const LazyCardGrid = defineAsyncComponent(() => import("./_nuxt/CardGrid-AhjqFBlE.js").then((r) => r.default));
const LazyVoltaBoard = defineAsyncComponent(() => import("./_nuxt/VoltaBoard-Qwa34pkE.js").then((r) => r.default));
const LazyComponentPlayground = defineAsyncComponent(() => import("./_nuxt/ComponentPlayground-o6D5LTxf.js").then((r) => r.default));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundData-dp3WjC5I.js").then((r) => r.default));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundProps-dFca0kq7.js").then((r) => r.default));
const LazyComponentPlaygroundSlots = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundSlots-mO9uLF3x.js").then((r) => r.default));
const LazyComponentPlaygroundTokens = defineAsyncComponent(() => import("./_nuxt/ComponentPlaygroundTokens-22OuyAwx.js").then((r) => r.default));
const LazyPreviewLayout = defineAsyncComponent(() => import("./_nuxt/PreviewLayout-fhZELgjh.js").then((r) => r.default));
const LazyTokensPlayground = defineAsyncComponent(() => import("./_nuxt/TokensPlayground-F0aQV6k3.js").then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-RYOpKTdm.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-Ui11U-0G.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-3qZStwWF.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-jQs58dvK.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-npCvl6uL.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-jXlJ4h_S.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-Mgo3qbbS.js").then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import("./_nuxt/DocumentDrivenEmpty-kO7tUmPk.js").then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-qN8tQbFC.js").then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/ProsePre-nLHcu85m.js").then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/ProseScript-citOi-4P.js").then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-3UssWu26.js").then((r) => r.default));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./_nuxt/client-db-YnSilivo.js").then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./_nuxt/client-db-YnSilivo.js").then((m) => m.generateNavigation);
...
const layouts = {
  article: () => import("./_nuxt/article-1x89ezoT.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-Gac-dOpD.js").then((m) => m.default || m),
  page: () => import("./_nuxt/page-5dMQT9jH.js").then((m) => m.default || m)
};
...
const plugin = {
  install(app, options) {
    ...
    if (dev && true) {
      import("./_nuxt/debug-jYE9BtgL.js").then(({ usePinceauRuntimeDebug }) => usePinceauRuntimeDebug(tokensHelperConfig));
    }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-J_Uxkg9H.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-YrMvs_Zs.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-Vzi5fBap.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  ...
  useContentHead as j,
  __nuxt_component_1$2 as k,
  layouts as l,
  useContentPreview as m,
  asyncDataDefaults as n,
  useAppConfig as o,
  usePinceauRuntime as p,
  queryContent as q,
  computedStyle as r,
  useColorMode as s,
  usePinceauTheme as t,
  useHead as u,
  useState as v,
  fetchContentNavigation as w,
  get$1 as x,
  assertArray as y,
  ensureArray as z
};
