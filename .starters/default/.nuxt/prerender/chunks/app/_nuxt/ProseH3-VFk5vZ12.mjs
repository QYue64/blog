...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h3${ssrRenderAttrs(mergeProps({ id: _ctx.id }, _attrs))} data-v-1d225d87>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt-themes+typography@0.11.0_rollup@3.29.3_vue@3.4.15/node_modules/@nuxt-themes/typography/components/global/ProseH3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProseH3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1d225d87"]]);

export { ProseH3 as default };
//# sourceMappingURL=ProseH3-VFk5vZ12.mjs.map
