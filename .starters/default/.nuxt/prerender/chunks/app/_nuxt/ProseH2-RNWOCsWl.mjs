...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h2${ssrRenderAttrs(mergeProps({ id: _ctx.id }, _attrs))} data-v-50b70a6c>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/@nuxt-themes+typography@0.11.0_rollup@3.29.3_vue@3.4.15/node_modules/@nuxt-themes/typography/components/global/ProseH2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProseH2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-50b70a6c"]]);

export { ProseH2 as default };
//# sourceMappingURL=ProseH2-RNWOCsWl.mjs.map
