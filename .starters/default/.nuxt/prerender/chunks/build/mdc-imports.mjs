import { visit } from 'file:///Users/jiyankang/vscodeProjects/witque-blog/node_modules/.pnpm/unist-util-visit@5.0.0/node_modules/unist-util-visit/index.js';
...
const rehypePlugins = {
  'highlight': { instance: rehypeShiki, options: {"src":"/Users/jiyankang/vscodeProjects/witque-blog/node_modules/.pnpm/@nuxtjs+mdc@0.3.2_rollup@3.29.3/node_modules/@nuxtjs/mdc/dist/runtime/shiki/index.mjs"} },
};

const highlight = {"theme":{"default":"github-light","dark":"github-dark"},"preload":["json","js","ts","html","css","vue","diff","shell","markdown","yaml","bash","ini","c","cpp"]};
